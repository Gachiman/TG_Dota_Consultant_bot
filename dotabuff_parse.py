...
def get_heroes_list():
    ...
    heroes_list = doc.xpath('/html/body/div[1]/div[8]/div[3]/section[2]/footer/div/a/div/div[1]/text()')
...
def get_heroes_cryptonyt(hero_name):
    ...
    # cryptonyt = [(item,) for item in zip(cryptonyt_name, cryptonyt_value)]
...
if __name__ == '__main__':
    ...
    # print(get_heroes_list())
    create_table_heroes_list(sql_connection())
    # print(list(get_heroes_cryptonyt('alchemist')))
